    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="absolute top-[5px] right-[5px] font-serif text-[11px] text-[#1c160e] font-bold opacity-75 group-hover:opacity-100 transition-opacity mix-blend-multiply pointer-events-none">
            ✕
          </span>
        </button>
