...
export const boardItems: BoardItem[] = [
  ...
  },
  {
    ...
    popupId: "suspect-2",
    desktop: { left: 70, top: 8, width: 12, rotation: 8 },
    mobile: { left: 68, top: 12, width: 26, rotation: 8 },
  },
  {
    id: "note",
    name: "Записка о расписании",
    popupId: "schedule",
    desktop: { left: 8, top: 46, width: 15, rotation: 4 },
    mobile: { left: 8, top: 70, width: 32, rotation: 4 },
  },
  {
    id: "map",
  ...
  },
  {
    ...
    desktop: { left: 6, top: 72, width: 13, rotation: 6 },
    mobile: { left: 12, top: 120, width: 30, rotation: 6 },
  },
  {
    id: "clock",
    name: "Часы начала",
    popupId: "schedule",
    desktop: { left: 42, top: 8, width: 9, rotation: -12 },
    mobile: { left: 44, top: 15, width: 20, rotation: -12 },
  },
  {
    id: "evidence",
