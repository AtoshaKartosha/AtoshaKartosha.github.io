...
export const boardItems: BoardItem[] = [
  {
    ...
    mobile: { left: 32, top: 26, width: 34, rotation: -2 },
  },
  {
    id: "suspect-1",
    ...
    mobile: { left: 10, top: 8, width: 22, rotation: -8 },
  },
  {
    id: "suspect-2",
    ...
    mobile: { left: 72, top: 8, width: 22, rotation: 6 },
  },
  {
    id: "note",
    ...
    mobile: { left: 8, top: 48, width: 20, rotation: 4 },
  },
  {
    id: "map",
    ...
    mobile: { left: 34, top: 58, width: 28, rotation: -4 },
  },
  {
    id: "phone",
    ...
    mobile: { left: 8, top: 76, width: 24, rotation: 4 },
  },
  {
    id: "clock",
    name: "Часы начала",
    ...
    mobile: { left: 38, top: 8, width: 14, rotation: -12 },
  },
  {
    id: "evidence",
    ...
    mobile: { left: 68, top: 72, width: 22, rotation: 12 },
  },
  {
    id: "newspaper",
    ...
    mobile: { left: 68, top: 34, width: 24, rotation: -5 },
  },
];
