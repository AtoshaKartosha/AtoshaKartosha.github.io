...
export const boardItems: BoardItem[] = [
  {
    ...
    popupId: "event-info",
    zIndex: 14,
    desktop: { left: 34, top: 18, width: 26, rotation: -2 },
  ...
  },
  {
    ...
    popupId: "location",
    zIndex: 15,
    desktop: { left: 53, top: 48, width: 13, rotation: -4 },
  ...
  },
  {
    ...
    popupId: "schedule",
    zIndex: 12,
    desktop: { left: 64, top: 38, width: 8, rotation: -12 },
  ...
  },
  {
    ...
    popupId: "newspaper",
    zIndex: 9,
    desktop: { left: 69, top: 26, width: 11, rotation: -5 },
